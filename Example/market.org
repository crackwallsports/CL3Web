            ...
            ,@(map 'list
                   (lambda (item)
                     (destructuring-bind (name num price rcd il) item
                       `(li (:class "table")
                            (div (:class "row")
                                 (input (:class "name col w-6" :id "name"
                                                :type "text" :placeholder "???" :value ,name
                                                :onblur "editCancel()"))
                                 (input (:class "quantity col w-2" :id "quantity"
                                                :type "text" :placeholder "???" :value ,(format nil "~A个" num)
                                                :onblur "editCancel()"))
                                 (input (:class "price col w-2" :id "price"
      ...
      (case (@ e key-code)
        ...
        (13 ;; "Enter"
         ...
         ,(jq-ajax "/inventory/edited"
                   :data '(create
                           :index (chain ($ ".table") (index (chain ($ obj) (parent) (parent))))
